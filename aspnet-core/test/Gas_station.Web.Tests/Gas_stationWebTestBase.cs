...
{
    public abstract class Gas_stationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Gas_stationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Gas_stationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Gas_stationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Gas_stationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Gas_stationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Gas_stationDbContext, Task<T>> func)
        {
            T result;
